...
class Grit_WP_Widget_Recent_Posts extends WP_Widget 
	{
		...
		*/
			...
			?>
			 ...
			 <h2 class="widget-title"><?php if ( $title ) echo esc_html( $title ); ?></h2>
				<ul class="media-list main-list ltst-upd">
					...
					{
					   the_post_thumbnail('grit_recent_post');
					}   
					?>
							</a>
							<div class="media-body">
								...
								<p class="by-author"><a href="<?php the_permalink() ?>"><?php esc_html_e('Read more', 'grit'); ?></a></p>
								<?php if ( $show_date ) : ?>
		...
		function form( $instance ) 
		{
			...
			?>
			<p>
				 <label for="<?php echo esc_html( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:','grit' ); ?></label>
				 <input id="<?php echo esc_html( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_html( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
			</p>

			<p>
				<label for="<?php echo esc_html( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show:','grit' ); ?></label>
			...
			<p>
				...
				<label for="<?php echo esc_html( $this->get_field_id( 'show_date' ) ); ?>"><?php esc_html_e( 'Display post date?','grit' ); ?></label>
			</p>
			<?php
		 }
	}
	...
	{
		register_widget('Grit_WP_Widget_Recent_Posts');
	}
	add_action('widgets_init','Grit_WP_Widget_Recent_Posts_init');
?>